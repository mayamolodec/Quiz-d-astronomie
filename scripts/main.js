...
function showQuestion(){
    cardImage.src = questions[question_index]['img_link'];
    quizCard.prepend(cardImage);

    questionText.textContent = questions[question_index]['question'];
    ...
    // Answers
    for (let answerText of questions[question_index]['answers']){
